...
export default function WatchPage(request) {
	...
	return (
		...
		<div className="bg-yellow-500 w-full h-fit mt-8 py-8 flex flex-col items-center justify-start gap-6 lg:flex lg:flex-row lg:px-12 lg:items-start lg:justify-center lg:px-38">
			<div className="w-10/12 lg:w-8/12">
				<video src={`${process.env.apihost}/api/watch/${mainVideo.hash}`} className="w-full rounded-xl" controls={true} autoPlay={true}>
					
				</video>
				<section className="metadata">
					<div className="video-metadata flex flex-col pl-2 pr-8">
						<h1 className="w-full py-4 font-bold text-xl text-left text-black">{mainVideo.title}</h1>
